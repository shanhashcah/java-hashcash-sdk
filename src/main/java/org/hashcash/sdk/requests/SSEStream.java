...
import org.hashcash.sdk.responses.GsonSingleton;
...
public class SSEStream<T extends org.hashcash.sdk.responses.Response> implements Closeable {
  ...
  static <T extends org.hashcash.sdk.responses.Response> SSEStream<T> create(
  ...
  private static <T extends org.hashcash.sdk.responses.Response> EventSource doStreamRequest(
    ...
    Request request = builder
            .build();
    RealEventSource eventSource = new RealEventSource(request, new HcNetEventSourceListener<T>(stream,closeListener, responseClass, requestBuilder, listener));
  ...
  private static class HcNetEventSourceListener<T extends org.hashcash.sdk.responses.Response> extends EventSourceListener {
    ...
    HcNetEventSourceListener(SSEStream<T> stream, CloseListener closeListener, Class<T> responseClass, RequestBuilder requestBuilder, EventListener<T> listener) {
      this.stream = stream;
