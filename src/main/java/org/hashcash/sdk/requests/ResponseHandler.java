...
import org.hashcash.sdk.responses.TypedResponse;
...
public class ResponseHandler<T> {
  ...
  public T handleResponse(final Response response) throws IOException, TooManyRequestsException {
    try {
      ...
      if (object instanceof org.hashcash.sdk.responses.Response) {
        ((org.hashcash.sdk.responses.Response) object).setHeaders(response.headers());
      }
