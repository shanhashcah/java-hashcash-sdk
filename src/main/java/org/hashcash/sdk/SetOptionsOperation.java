...
public class SetOptionsOperation extends Operation {
  ...
  /**
   * Indicates which flags to clear. For details about the flags.
  ...
  org.hashcash.sdk.xdr.Operation.OperationBody toOperationBody() {
    ...
    if (signer != null) {
      org.hashcash.sdk.xdr.Signer signer = new org.hashcash.sdk.xdr.Signer();
  ...
  public static class Builder {
     ...
     * @param signer The signer key. Use {@link org.hashcash.sdk.Signer} helper to create this object.
