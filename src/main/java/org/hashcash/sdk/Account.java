...
/**
 * Represents an account in HC-Net network with it's sequence number.
 * Account object is required to build a {@link Transaction}.
 * @see org.hashcash.sdk.Transaction.Builder
 */
public class Account implements TransactionBuilderAccount {
   ...
   * @param sequenceNumber Current sequence number of the account (can be obtained using java-hashcash-hdk or aurora server)
   */
