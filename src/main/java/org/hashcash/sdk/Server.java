...
import org.hashcash.sdk.requests.*;
import org.hashcash.sdk.responses.*;
...
/**
 * Main class used to connect to Aurora server.
 */
public class Server {
    ...
    /**
     * AURORA_SUBMIT_TIMEOUT is a time in seconds after Aurora sends a timeout response
     * after internal txsub timeout.
     */
    private static final int AURORA_SUBMIT_TIMEOUT = 60;
    ...
    public Server(String uri) {
        ...
        submitHttpClient = new OkHttpClient.Builder()
                .connectTimeout(10, TimeUnit.SECONDS)
                .readTimeout(AURORA_SUBMIT_TIMEOUT + 5, TimeUnit.SECONDS)
                .retryOnConnectionFailure(true)
                .build();
    }
     ...
     * @throws SubmitTransactionTimeoutResponseException When Aurora returns a <code>Timeout</code> or connection timeout occured.
     * @throws SubmitTransactionUnknownResponseException When unknown Aurora response is returned.
     * @throws IOException
     */
