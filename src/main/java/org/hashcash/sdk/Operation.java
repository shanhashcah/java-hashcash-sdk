...
import org.hashcash.sdk.xdr.XdrDataOutputStream;
...
public abstract class Operation {
   ...
   */
  public org.hashcash.sdk.xdr.Operation toXdr() {
    org.hashcash.sdk.xdr.Operation xdr = new org.hashcash.sdk.xdr.Operation();
  ...
  public String toXdrBase64() {
    try {
      org.hashcash.sdk.xdr.Operation operation = this.toXdr();
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      org.hashcash.sdk.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(org.hashcash.sdk.xdr.Operation xdr) {
    org.hashcash.sdk.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   */
  abstract org.hashcash.sdk.xdr.Operation.OperationBody toOperationBody();
}
