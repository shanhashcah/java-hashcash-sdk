...
import org.hashcash.sdk.xdr.Uint64;
...
final public class TimeBounds {
	...
	public static TimeBounds fromXdr(org.hashcash.sdk.xdr.TimeBounds timeBounds) {
		if (timeBounds == null) {
			return null;
		}
	...
	public org.hashcash.sdk.xdr.TimeBounds toXdr() {
		org.hashcash.sdk.xdr.TimeBounds timeBounds = new org.hashcash.sdk.xdr.TimeBounds();
