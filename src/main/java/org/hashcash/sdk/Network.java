...
/**
 * Network class is used to specify which HC-Net network you want to use.
...
public class Network {
    private final static String PUBLIC = "Public Global HC-Net Network ; September 2015";
