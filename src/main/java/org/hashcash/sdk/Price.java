...
import org.hashcash.sdk.xdr.Int32;

import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents Price. Price in HC-Net is represented as a fraction.
 */
public class Price {
    @SerializedName("n")
    private final int n;
    ...
    /**
     * Create a new price. Price in HC-Net is represented as a fraction.
     * @param n numerator
     * @param d denominator
     */
     ...
     */
    public org.hashcash.sdk.xdr.Price toXdr() {
        org.hashcash.sdk.xdr.Price xdr = new org.hashcash.sdk.xdr.Price();
        Int32 n = new Int32();
        Int32 d = new Int32();
        n.setInt32(this.n);
        d.setInt32(this.d);
