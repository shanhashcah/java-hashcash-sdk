...
import org.hashcash.sdk.xdr.SignerKey;
import org.hashcash.sdk.xdr.SignerKeyType;
import org.hashcash.sdk.xdr.Uint256;

/**
 * Signer is a helper class that creates {@link org.hashcash.sdk.xdr.SignerKey} objects.
 */
public class Signer {
    /**
     * Create <code>ed25519PublicKey</code> {@link org.hashcash.sdk.xdr.SignerKey} from
     * a {@link org.hashcash.sdk.KeyPair}
     * @param keyPair
     * @return org.hashcash.hdk.xdr.SignerKey
     */
    ...
    /**
     * Create <code>sha256Hash</code> {@link org.hashcash.sdk.xdr.SignerKey} from
    ...
    /**
     * Create <code>preAuthTx</code> {@link org.hashcash.sdk.xdr.SignerKey} from
     * a {@link org.hashcash.sdk.xdr.Transaction} hash.
     * @param tx
     * @return org.hashcash.hdk.xdr.SignerKey
     */
