...
import com.hashcash.sdk.xdr.Int32;
...
public class Price {
     ...
     */
    public static Price fromXdr(com.hashcash.sdk.xdr.Price price) {
     ...
     */
    public com.hashcash.sdk.xdr.Price toXdr() {
        com.hashcash.sdk.xdr.Price xdr = new com.hashcash.sdk.xdr.Price();
        Int32 n = new Int32();
        Int32 d = new Int32();
        n.setInt32(this.n);
        d.setInt32(this.d);
