...
import com.hashcash.sdk.TransactionPreconditions.TransactionPreconditionsBuilder;
...
import static com.hashcash.sdk.TransactionPreconditions.TIMEOUT_INFINITE;
...
public class TransactionBuilder {
    ...
    public static com.hashcash.sdk.xdr.TimeBounds buildTimeBounds(long minTime, long maxTime) {
        return new com.hashcash.sdk.xdr.TimeBounds.Builder().minTime(new TimePoint(new Uint64(minTime)))
