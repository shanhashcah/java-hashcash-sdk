...
import com.hashcash.sdk.xdr.PreconditionType;
import com.hashcash.sdk.xdr.Preconditions;
import com.hashcash.sdk.xdr.PreconditionsV2;
    ...
    public Preconditions toXdr() {
        ...
        if (hasV2()) {
            ...
            if (ledgerBounds != null) {
                v2Builder.ledgerBounds(new com.hashcash.sdk.xdr.LedgerBounds.Builder()
