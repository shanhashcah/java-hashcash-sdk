...
public abstract class LiquidityPoolParameters {
   ...
   */
  public static LiquidityPoolParameters fromXdr(com.hashcash.sdk.xdr.LiquidityPoolParameters xdr) {
   ...
   */
  public abstract com.hashcash.sdk.xdr.LiquidityPoolParameters toXdr();

  public abstract com.hashcash.sdk.LiquidityPoolID getId();
}
