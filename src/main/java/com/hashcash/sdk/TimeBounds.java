...
final public class TimeBounds {
	...
	public static TimeBounds fromXdr(com.hashcash.sdk.xdr.TimeBounds timeBounds) {
		if (timeBounds == null) {
			return null;
		}
	...
	public com.hashcash.sdk.xdr.TimeBounds toXdr() {
		com.hashcash.sdk.xdr.TimeBounds timeBounds = new com.hashcash.sdk.xdr.TimeBounds();
