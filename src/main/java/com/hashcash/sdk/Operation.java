...
public abstract class Operation {
   ...
   */
  public com.hashcash.sdk.xdr.Operation toXdr(AccountConverter accountConverter) {
    com.hashcash.sdk.xdr.Operation xdr = new com.hashcash.sdk.xdr.Operation();
   ...
   * Generates Operation XDR object.
   */
  public com.hashcash.sdk.xdr.Operation toXdr() {
  ...
  public String toXdrBase64(AccountConverter accountConverter) {
    try {
      com.hashcash.sdk.xdr.Operation operation = this.toXdr(accountConverter);
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      com.hashcash.sdk.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(AccountConverter accountConverter, com.hashcash.sdk.xdr.Operation xdr) {
    com.hashcash.sdk.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   * @param xdr XDR object
   */
  public static Operation fromXdr(com.hashcash.sdk.xdr.Operation xdr) {
   ...
   */
  abstract com.hashcash.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter);
}
