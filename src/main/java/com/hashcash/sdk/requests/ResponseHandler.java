...
import com.hashcash.sdk.responses.TypedResponse;
...
public class ResponseHandler<T> {
  ...
  public T handleResponse(final Response response) throws IOException, TooManyRequestsException {
    try {
      ...
      if (object instanceof com.hashcash.sdk.responses.Response) {
        ((com.hashcash.sdk.responses.Response) object).setHeaders(response.headers());
      }
