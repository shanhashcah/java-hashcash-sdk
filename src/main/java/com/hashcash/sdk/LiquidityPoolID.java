...
public final class LiquidityPoolID {
   ...
   */
  public static LiquidityPoolID fromXdr(com.hashcash.sdk.xdr.PoolID xdr) {
   ...
   */
  public com.hashcash.sdk.xdr.PoolID toXdr() {
    com.hashcash.sdk.xdr.PoolID xdr = new com.hashcash.sdk.xdr.PoolID();
    xdr.setPoolID(new com.hashcash.sdk.xdr.Hash(hash));
    return xdr;
  }
}
