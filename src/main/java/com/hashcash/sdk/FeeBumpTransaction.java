...
import com.hashcash.sdk.xdr.FeeBumpTransactionEnvelope;
...
public class FeeBumpTransaction extends AbstractTransaction {
  ...
  public static FeeBumpTransaction fromFeeBumpTransactionEnvelope(FeeBumpTransactionEnvelope envelope, Network network) {
    ...
    private com.hashcash.sdk.xdr.FeeBumpTransaction toXdr() {
    com.hashcash.sdk.xdr.FeeBumpTransaction xdr = new com.hashcash.sdk.xdr.FeeBumpTransaction();
    xdr.setExt(new com.hashcash.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionExt());
    ...
    com.hashcash.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionInnerTx innerXDR = new com.hashcash.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionInnerTx();
