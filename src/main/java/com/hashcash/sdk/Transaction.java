...
import com.hashcash.sdk.xdr.ClaimableBalanceID;
import com.hashcash.sdk.xdr.ClaimableBalanceIDType;
import com.hashcash.sdk.xdr.DecoratedSignature;
import com.hashcash.sdk.xdr.EnvelopeType;
import com.hashcash.sdk.xdr.Hash;
import com.hashcash.sdk.xdr.Int64;
import com.hashcash.sdk.xdr.OperationID;
import com.hashcash.sdk.xdr.SequenceNumber;
import com.hashcash.sdk.xdr.TransactionEnvelope;
import com.hashcash.sdk.xdr.TransactionSignaturePayload;
import com.hashcash.sdk.xdr.TransactionV0;
import com.hashcash.sdk.xdr.TransactionV0Envelope;
import com.hashcash.sdk.xdr.TransactionV1Envelope;
import com.hashcash.sdk.xdr.Uint32;
import com.hashcash.sdk.xdr.XdrDataOutputStream;
...
public class Transaction extends AbstractTransaction {
  ...
  private TransactionV0 toXdr() {
    ...
    // operations
    com.hashcash.sdk.xdr.Operation[] operations = new com.hashcash.sdk.xdr.Operation[mOperations.length];
  ...
  private com.hashcash.sdk.xdr.Transaction toV1Xdr(AccountConverter accountConverter) {
    ...
    // ext
    com.hashcash.sdk.xdr.Transaction.TransactionExt ext = new com.hashcash.sdk.xdr.Transaction.TransactionExt();
    ext.setDiscriminant(0);

    com.hashcash.sdk.xdr.Transaction v1Tx = new com.hashcash.sdk.xdr.Transaction();
    v1Tx.setFee(fee);
   ...
   * @see com.hashcash.sdk.TransactionBuilder
   */
