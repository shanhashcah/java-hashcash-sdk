...
public class SetOptionsOperation extends Operation {
  ...
  com.hashcash.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter) {
    ...
    if (signer != null) {
      com.hashcash.sdk.xdr.Signer signer = new com.hashcash.sdk.xdr.Signer();
  ...
  public static class Builder {
     ...
     * @param signer The signer key. Use {@link com.hashcash.sdk.Signer} helper to create this object.
