...
import com.hashcash.sdk.xdr.LiquidityPoolDepositOp;
...
public class LiquidityPoolDepositOperation extends Operation {
    ...
    OperationBody toOperationBody(AccountConverter accountConverter) {
        ...
        op.setMaxAmountA(new com.hashcash.sdk.xdr.Int64(Operation.toXdrAmount(this.getMaxAmountA())));
        op.setMaxAmountB(new com.hashcash.sdk.xdr.Int64(Operation.toXdrAmount(this.getMaxAmountB())));
