...
import com.hashcash.sdk.xdr.Operation.OperationBody;
import com.hashcash.sdk.xdr.LiquidityPoolType;
import com.hashcash.sdk.xdr.LiquidityPoolWithdrawOp;
...
public class LiquidityPoolWithdrawOperation extends Operation {
    ...
    OperationBody toOperationBody(AccountConverter accountConverter) {
        ...
        op.setAmount(new com.hashcash.sdk.xdr.Int64(Operation.toXdrAmount(this.getAmount())));
        op.setMinAmountA(new com.hashcash.sdk.xdr.Int64(Operation.toXdrAmount(this.getMinAmountA())));
        op.setMinAmountB(new com.hashcash.sdk.xdr.Int64(Operation.toXdrAmount(this.getMinAmountB())));

        OperationBody body = new com.hashcash.sdk.xdr.Operation.OperationBody();
