...
public abstract class TrustLineAsset implements Comparable<TrustLineAsset> {
   ...
   */
  public static TrustLineAsset fromXdr(com.hashcash.sdk.xdr.TrustLineAsset xdr) {
   ...
   * @return xdr model
   */
  public abstract com.hashcash.sdk.xdr.TrustLineAsset toXdr();
  ...
  public static final class Wrapper extends TrustLineAsset {
    ...
    @Override
    public com.hashcash.sdk.xdr.TrustLineAsset toXdr() {
      com.hashcash.sdk.xdr.TrustLineAsset xdr = new com.hashcash.sdk.xdr.TrustLineAsset();
