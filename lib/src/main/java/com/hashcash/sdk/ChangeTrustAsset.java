...
public abstract class ChangeTrustAsset implements Comparable<ChangeTrustAsset> {
   ...
   * @return    ChangeTrustAsset
   */
  public static ChangeTrustAsset fromXdr(com.hashcash.sdk.xdr.ChangeTrustAsset xdr) {
   ...
   * @return xdr model
   */
  public abstract com.hashcash.sdk.xdr.ChangeTrustAsset toXdr();
  ...
  public static final class Wrapper extends ChangeTrustAsset {
    ...
    @Override
    public com.hashcash.sdk.xdr.ChangeTrustAsset toXdr() {
      com.hashcash.sdk.xdr.ChangeTrustAsset xdr = new com.hashcash.sdk.xdr.ChangeTrustAsset();

      com.hashcash.sdk.xdr.Asset assetXdr = asset.toXdr();
