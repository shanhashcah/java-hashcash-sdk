...
public class CreateClaimableBalanceOperation extends Operation {
  ...
  com.hashcash.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter) {
    ...
    com.hashcash.sdk.xdr.Claimant[] xdrClaimants = new com.hashcash.sdk.xdr.Claimant[claimants.size()];
    for (int i = 0; i < claimants.size(); i++) {

      com.hashcash.sdk.xdr.Claimant.ClaimantV0 v0 = new com.hashcash.sdk.xdr.Claimant.ClaimantV0();
      ...
      xdrClaimants[i] = new com.hashcash.sdk.xdr.Claimant();
  ...
  public static class Builder {
    ...
    Builder(CreateClaimableBalanceOp op) {
      ...
      for(com.hashcash.sdk.xdr.Claimant c : op.getClaimants()) {
