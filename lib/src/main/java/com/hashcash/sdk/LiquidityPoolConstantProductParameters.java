...
import com.hashcash.sdk.xdr.LiquidityPoolType;
...
public final class LiquidityPoolConstantProductParameters extends LiquidityPoolParameters {
   ...
   */
  @Override
  public final com.hashcash.sdk.xdr.LiquidityPoolParameters toXdr() {
    com.hashcash.sdk.xdr.LiquidityPoolParameters xdr = new com.hashcash.sdk.xdr.LiquidityPoolParameters();
    xdr.setDiscriminant(LiquidityPoolType.LIQUIDITY_POOL_CONSTANT_PRODUCT);

    com.hashcash.sdk.xdr.LiquidityPoolConstantProductParameters params = new com.hashcash.sdk.xdr.LiquidityPoolConstantProductParameters();
    params.setAssetA(assetA.toXdr());
    params.setAssetB(assetB.toXdr());
    params.setFee(new com.hashcash.sdk.xdr.Int32(fee));
   ...
   */
  public static LiquidityPoolConstantProductParameters fromXdr(com.hashcash.sdk.xdr.LiquidityPoolConstantProductParameters xdr) {
